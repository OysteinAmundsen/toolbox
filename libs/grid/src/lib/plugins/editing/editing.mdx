...
{/* AI-CONTEXT: For structured, AI-optimized documentation about this plugin,
    ...
    — section: "### EditingPlugin" (under "## Plugin Configuration Reference") */}
...
| `dirty-change` | [`DirtyChangeDetail`](/docs/grid-plugins-editing-interfaces-dirtychangedetail--docs) | Fired when a row's dirty state changes (requires `dirtyTracking: true`) |
