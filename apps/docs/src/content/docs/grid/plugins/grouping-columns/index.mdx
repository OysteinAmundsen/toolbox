...
HTML strings returned from the renderer are automatically sanitized (scripts and event-handler attributes are stripped) — see [What the grid sanitizes for you](/grid/platform/#what-the-grid-sanitizes-for-you).
