{/* AI-CONTEXT: For structured, AI-optimized documentation about this plugin,
    ...
    — section: "### VisibilityPlugin" (under "## Plugin Configuration Reference") */}
...
> 💡 **Optional Enhancement:** When [ReorderPlugin](/docs/grid-plugins-reorder--docs) is also loaded, columns in the visibility panel become draggable for reordering.
