...
The demo will be available at http://localhost:4300/employee-management

## Project Structure

```
demos/react/src/demos/employee-management/
├── EmployeeManagement.tsx     # Main component (control panel + DataGrid)
...
│       ├── AnalyticsPanel.tsx
│       └── QuickFiltersPanel.tsx
└── README.md                  # This file
```

The shell that hosts this demo lives at [`demos/react/`](../../..) — see its README for the router setup.
...
- [Vanilla implementation](../../../../vanilla/src/demos/employee-management/README.md)
