{/* CustomPlugins.mdx */}
{/* AI-CONTEXT: For structured, AI-optimized documentation about creating custom plugins,
...
- **[API Reference — Plugin Methods](?path=/docs/grid-api--docs#plugin-methods)** — `getPluginByName()`, `getPlugin()`, and other plugin access methods
