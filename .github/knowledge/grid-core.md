...
Core = `libs/grid/src/lib/core/`. Shell chrome = PLUGIN → grid-plugins-shell.md. Render scheduler, virtualization, rows hot path, value-accessor, row-manager, sorting, aggregators → grid-render-pipeline.md.
