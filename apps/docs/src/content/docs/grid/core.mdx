...
| `typeDefaults` | <code>Record&lt;string, <a href="/grid/api/core/interfaces/typedefault/">TypeDefault</a>&gt;</code> | Default format/renderer per column `type` |
...
- Type-level editors require the editing feature/plugin to be enabled in your runtime/framework package.
