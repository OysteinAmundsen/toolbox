...
- **[llms.txt](https://github.com/OysteinAmundsen/toolbox/blob/main/llms.txt)** — Concise overview with links to all documentation
- **[llms-full.txt](https://github.com/OysteinAmundsen/toolbox/blob/main/llms-full.txt)** — Comprehensive implementation guide with code examples, CSS variables, and plugin patterns
