...
| --------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| Vanilla   | (none — native web component) | [demos/vanilla/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox-web/tree/main/demos/vanilla/src/demos/employee-management) |
| Angular   | `@toolbox-web/grid-angular` | [demos/angular/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox-web/tree/main/demos/angular/src/demos/employee-management) |
| React     | `@toolbox-web/grid-react`   | [demos/react/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox-web/tree/main/demos/react/src/demos/employee-management) |
| Vue       | `@toolbox-web/grid-vue`     | [demos/vue/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox-web/tree/main/demos/vue/src/demos/employee-management) |

Each demo uses the same shared data generators and types from `demos/shared/employee-management/`, ensuring consistent behavior across all implementations. The vanilla demo acts as the reference implementation, and its `createEmployeeGrid()` factory function is reused in these documentation pages.
