...
**Since 2.10.0.** When the [`GroupingColumnsPlugin`](/grid/plugins/grouping-columns/) is installed alongside the export plugin, column group headers are automatically included above the leaf headers — fixing [issue #314](https://github.com/OysteinAmundsen/toolbox/issues/314).
