...
See the [Advanced Usage guide](/docs/grid-angular-advanced-usage--docs#feature-scoped-inject-functions) for full documentation, examples, and available inject functions.

## Next Steps

- **[Advanced Usage](/docs/grid-angular-advanced-usage--docs)** — Manual plugins, server-side data, responsive layouts, performance tips
