/**
 * Data Generation Module for Employee Management Demo
 *
 * This module contains all constants and data generator functions used to create
 * realistic employee data for the Employee Management Storybook demo. It provides
 * randomized but realistic-looking enterprise HR data including employees, projects,
