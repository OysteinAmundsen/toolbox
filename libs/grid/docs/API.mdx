...
### Column Configuration — [`ColumnConfig`](/docs/grid-api-core-interfaces-columnconfig--docs)
...
### Grid Configuration — [`GridConfig`](/docs/grid-api-core-interfaces-gridconfig--docs)
...
#### typeDefaults — [`TypeDefault`](/docs/grid-api-core-interfaces-typedefault--docs)
...
### Animation Configuration — [`AnimationConfig`](/docs/grid-api-core-interfaces-animationconfig--docs)
...
### Shell Configuration — [`ShellConfig`](/docs/grid-api-core-interfaces-shellconfig--docs)
...
### Icon Customization — [`GridIcons`](/docs/grid-api-core-interfaces-gridicons--docs)
