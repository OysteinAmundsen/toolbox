{/* Accessibility.mdx */}
{/* AI-CONTEXT: For structured, AI-optimized documentation about this library,
...
- **[API Reference — Keyboard Shortcuts](?path=/docs/grid-api--docs#keyboard-shortcuts)** — Complete keyboard shortcut reference
- **[Theming](?path=/docs/grid-theming--docs)** — High contrast themes and CSS variable customization
- **[Performance Guide](?path=/docs/grid-dev-performance--docs)** — Reduced motion and animation configuration
