...
// of every name the adapter previously accepted. The prior shape was a
// hand-listed union of 24 names (stickyRows was missing — switching to
// `keyof FeatureConfig` adds it, which is additive). If any of these names
// stops being assignable to `FeatureName`, this file fails to compile.
// ─────────────────────────────────────────────────────────────────────────
