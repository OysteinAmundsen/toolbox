...
Experiment with all core grid options using the controls below.
...
<Canvas of={GridStories.ShellBasic} />

### Light DOM Shell Configuration

<Canvas of={GridStories.ShellLightDOMConfig} />

### Multiple Tool Panels

<Canvas of={GridStories.ShellMultiplePanels} />

### Toolbar Buttons

<Canvas of={GridStories.ShellToolbarButtons} />
