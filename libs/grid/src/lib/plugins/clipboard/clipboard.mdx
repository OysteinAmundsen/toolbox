...
> ⚠️ **Required Dependency:** This plugin requires [SelectionPlugin](/docs/grid-plugins-selection--docs) to be loaded first. Clipboard uses the selection state to determine which cells to copy.
