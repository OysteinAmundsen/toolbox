{/* AI-CONTEXT: For structured, AI-optimized documentation about this plugin,
    ...
    — section: "### TreePlugin" (under "## Plugin Configuration Reference") */}
...
- **[Master-Detail](../?path=/docs/grid-plugins-master-detail--docs)** — Expandable detail panels
- **[Pivot](../?path=/docs/grid-plugins-pivot--docs)** — Pivot table with row grouping
