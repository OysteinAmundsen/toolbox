...
This is the supported alternative to hiding `.tbw-toolbar-btn` and `.tbw-toolbar-separator` with CSS — no library DOM needs to be hidden, and you keep full control of the button's markup, attributes, and event handlers.
