{/* Comparison.mdx */}
{/* AI-CONTEXT: For structured, AI-optimized documentation about migration and differences,
    see https://raw.githubusercontent.com/OysteinAmundsen/toolbox/main/llms-full.txt
    — sections: "## Key Differences from AG Grid", "## Migration from AG Grid" */}
...
- **[Getting Started](?path=/docs/grid-getting-started--docs)** — Install and set up your first grid in minutes
- **[Demos](?path=/docs/grid-demos--docs)** — Full-featured employee management demo
- **[Plugins](?path=/docs/grid-plugins--docs)** — Complete plugin catalog with feature comparison
