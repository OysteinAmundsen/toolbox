...
<Canvas of={EmployeeManagement.GroupedByDepartment} />
...
The employee management demo is available in two implementations:
...
Both demos share the same data types and generators from `demos/employee-management/shared/`.
