...
{/* AI-CONTEXT: For structured, AI-optimized documentation about this topic,
    ...
    — sections: "## CRITICAL RULES", "## FRAMEWORK DECISION GUIDE" */}
...
See the [Vue adapter README](https://github.com/OysteinAmundsen/toolbox/tree/main/libs/grid-vue#readme) for the complete API reference.
