...
| --------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| Vanilla   | (none — native web component) | [demos/vanilla/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox/tree/main/demos/vanilla/src/demos/employee-management) |
| Angular   | `@toolbox-web/grid-angular` | [demos/angular/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox/tree/main/demos/angular/src/demos/employee-management) |
| React     | `@toolbox-web/grid-react`   | [demos/react/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox/tree/main/demos/react/src/demos/employee-management) |
| Vue       | `@toolbox-web/grid-vue`     | [demos/vue/src/demos/employee-management/](https://github.com/OysteinAmundsen/toolbox/tree/main/demos/vue/src/demos/employee-management) |
