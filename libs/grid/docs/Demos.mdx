{/* Demos.mdx */}
{/* AI-CONTEXT: For structured, AI-optimized documentation about common tasks and recipes,
    see https://raw.githubusercontent.com/OysteinAmundsen/toolbox/main/llms-full.txt
    — section: "## TASK RECIPES" */}
...
This comprehensive demo showcases `@toolbox-web/grid` in a **production-ready enterprise scenario**—an Employee Management System handling 200+ employees with complex data relationships, multiple interaction patterns, and advanced features working together seamlessly.

> 📂 **View the source code**: [demos/employee-management/](https://github.com/OysteinAmundsen/toolbox/tree/main/demos/employee-management)
...
| **Filtering**       | Click filter icon (⊻) in any header                  |
...
| Feature           | Description                                                   |
| ----------------- | ------------------------------------------------------------- |
| **Master-Detail** | Click ▶ to expand rows and see projects + performance reviews |
| **Row Grouping**  | Toggle in controls above to group by department               |
| **Status Bar**    | Bottom bar shows row count and salary totals                  |
| **Export**        | Right-click → Export to CSV or JSON                           |

## Try These Interactions

1. **Filter Engineering employees**: Click the filter icon on "Dept" → select "Engineering"
...
4. **Expand an employee**: Click the ▶ arrow to see their projects and reviews
5. **Edit a salary**: Double-click a salary cell, change it, press Enter
6. **Undo the edit**: Press Ctrl+Z
7. **Export filtered data**: Right-click → Export → CSV
...
The employee management demo is available in four implementations:
...
| **Angular 21** | Standalone components, signals, template-driven renderers | [`demos/employee-management/angular/`](https://github.com/OysteinAmundsen/toolbox/tree/main/demos/employee-management/angular) |
...
| **Vue 3** | Composition API, slot-based renderers, composables | [`demos/employee-management/vue/`](https://github.com/OysteinAmundsen/toolbox/tree/main/demos/employee-management/vue) |
