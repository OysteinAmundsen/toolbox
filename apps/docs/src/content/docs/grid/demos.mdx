...
| --------- | --------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| Vanilla   | (none — native web component) | [demos/employee-management/vanilla/](https://github.com/nicoss54/toolbox-web/tree/main/demos/employee-management/vanilla) |
| Angular   | `@toolbox-web/grid-angular` | [demos/employee-management/angular/](https://github.com/nicoss54/toolbox-web/tree/main/demos/employee-management/angular) |
| React     | `@toolbox-web/grid-react`   | [demos/employee-management/react/](https://github.com/nicoss54/toolbox-web/tree/main/demos/employee-management/react)     |
| Vue       | `@toolbox-web/grid-vue`     | [demos/employee-management/vue/](https://github.com/nicoss54/toolbox-web/tree/main/demos/employee-management/vue)         |
