...
| `cell-activate`         | Cell activated (keyboard/click)     |
| `cell-commit`           | Cell value committed                |
| `row-commit`            | Row edit committed                  |
| `sort-change`           | Sort state changed                  |
| `column-resize`         | Column resized                      |
| `column-state-change`   | Column config changed               |
...
| `sort-model-change`        | MultiSort    |
| `export-start` / `export-complete` | Export |
| `clipboard-copy` / `clipboard-paste` | Clipboard |
| `context-menu-open`        | ContextMenu  |
| `column-visibility-change` | Visibility   |
| `column-reorder`           | Reorder      |
| `detail-expand`            | MasterDetail |
