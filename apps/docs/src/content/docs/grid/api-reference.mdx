...
See the [Browser Support matrix](/grid/guides/platform/#browser-support) for the per-feature breakdown, and the [Production Checklist](/grid/guides/production-checklist/) for deployment guidance.
