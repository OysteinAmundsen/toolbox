...
Real CI tests that also record the promo video. Their extra rules (overlay/pacing API, scene
authoring rules, plugin selector traps) live in `e2e-promo.instructions.md`, auto-applied when you
edit `apps/docs-e2e/tests/promo/**`.
