...
import { Tabs, TabItem, Steps, LinkCard, CardGrid, Aside } from '@astrojs/starlight/components';

<Aside type="tip" title="Using a framework?">
  Jump directly to a framework-specific guide:
  **[Angular](/grid/angular/getting-started/)** · **[React](/grid/react/getting-started/)** · **[Vue](/grid/vue/getting-started/)**
</Aside>
...
The grid is a standard web component that works in any JavaScript environment. For React, Vue, and Angular, we provide dedicated adapter packages that enable custom component renderers and editors.
