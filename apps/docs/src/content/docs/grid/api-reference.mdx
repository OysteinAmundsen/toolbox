...
| Shell layout (header, toolbar, tool panels) | [Core → Shell Components](/grid/core/#shell-components) and the [`ShellConfig` interface](/grid/api/core/interfaces/shellconfig/) |
