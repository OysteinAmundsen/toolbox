{/* Introduction.mdx */}
{/* AI-CONTEXT: For structured, AI-optimized documentation covering this entire library,
...
Also available via yarn, pnpm, bun, or CDN. See the [Getting Started guide](?path=/docs/grid-getting-started--docs#installation) for all options.
