...
// Log a representative set at once. This is a curated subset, not the full
// catalog — the `keyof DataGridEventMap` type is the complete, type-checked
// list of event names; add any others you need to the array below.
