...
import * as AllFeaturesStories from '../demo/employee-management.stories';
...
> 📂 **View the source code**: [libs/grid/demo/](https://github.com/OysteinAmundsen/toolbox/tree/main/libs/grid/demo)

## Live Demo

<Canvas of={AllFeaturesStories.AllFeatures} withToolbar/>

<Controls of={AllFeaturesStories.AllFeatures} />
...
<Canvas of={AllFeaturesStories.GroupedByDepartment} />
