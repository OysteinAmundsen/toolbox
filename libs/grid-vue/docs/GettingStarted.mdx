...
{/* AI-CONTEXT: For structured, AI-optimized documentation about the Vue adapter,
    ...
    — section: "## FRAMEWORK DEEP DIVE: Vue" */}
...
See the [Advanced Usage guide](/docs/grid-vue-advanced-usage--docs#the-usegridevent-composable) for full documentation and examples.
