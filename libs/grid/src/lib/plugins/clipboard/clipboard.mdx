{/* AI-CONTEXT: For structured, AI-optimized documentation about this plugin,
    ...
    — section: "### ClipboardPlugin" (under "## Plugin Configuration Reference") */}
...
- **[Selection](../?path=/docs/grid-plugins-selection--docs)** — Cell and row selection
- **[Editing](../?path=/docs/grid-plugins-editing--docs)** — Inline cell editing
- **[Export](../?path=/docs/grid-plugins-export--docs)** — Export to CSV/JSON
