...
| `'grid'`| All editors visible immediately. No exit edit mode.         |
...
- Enter commits the current cell value (stays in edit mode)
- Escape and click-outside have no effect (always editing)
