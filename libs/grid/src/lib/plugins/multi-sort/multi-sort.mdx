...
- **[Filtering](../?path=/docs/grid-plugins-filtering--docs)** — Column filtering
- **[Server-Side Data](../?path=/docs/grid-plugins-server-side-data--docs)** — Server-side sorting via `sortHandler`
- **[Core Configuration](../?path=/docs/grid-core--docs)** — Built-in single-column sorting
