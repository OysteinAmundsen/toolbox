...
| -------------------- | ------------------- | ---------- | ----------------------------------- |
| `cell-commit`        | [`CellCommitDetail`](/docs/grid-api-core-interfaces-cellcommitdetail--docs)  | ✅ Yes     | Cell value was edited (inline)      |
...
| `cell-activate` | ✅ Yes     | Cell activation is blocked                     |
